...
class Image {
    ...
    private:
        ...
        bool load_rgb( std::vector<unsigned char> raw);
        bool save_rgb( const std::string filename ) const;

        //bool load_rgba( std::vector<unsigned char> raw);
        //bool save_rgba( const std::string filename ) const;

        bool load_gray( std::vector<unsigned char> raw);
